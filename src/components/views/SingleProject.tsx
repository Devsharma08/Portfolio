...
export default function SingleProject({ project, onBack }: SingleProjectProps) {
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          position: 'relative',
          overflow: 'hidden',
          boxShadow: `0 0 20px ${project.color}0a`
        }}
      >
        <div
          style={{
          ...
          {project.stack.map((s, sIdx) => (
            <div key={sIdx} style={{ marginBottom: '20px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '10px' }}>
                <div style={{ width: '3px', height: '20px', borderRadius: '4px', background: `linear-gradient(180deg, ${project.color}, ${project.color}44)`, flexShrink: 0 }} />
                <span style={{ color: project.color, fontSize: '11px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.12em' }}>
                  {s.label}
                </span>
              </div>
